...
### [json-server](https://github.com/typicode/json-server) ⭐ 75,704 | 🐛 720 | 🌐 JavaScript | 📅 2026-03-23 - run a mock REST API server with JSON-based response configuration
...
### [pa11y](https://github.com/pa11y/pa11y) ⭐ 4,511 | 🐛 43 | 🌐 JavaScript | 📅 2026-08-28 - check websites for accessibility issues
...
### [npm-check](https://github.com/dylang/npm-check) ⭐ 6,642 | 🐛 232 | 🌐 JavaScript | 📅 2026-09-05 - interactively update npm dependencies
...
### [snyk](https://github.com/snyk/snyk) ⭐ 5,655 | 🐛 138 | 🌐 TypeScript | 📅 2026-09-05 - scan for vulnerabilities in your project and its dependencies and even fix them (requires account with service)
...
### [cowsay](https://github.com/piuccio/cowsay) ⭐ 1,313 | 🐛 16 | 🌐 JavaScript | 📅 2024-09-24 - adds cow ascii art to your special message
