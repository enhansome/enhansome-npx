...
### [http-server](https://github.com/indexzero/http-server) ⭐ 14,230 | 🐛 108 | 🌐 JavaScript | 📅 2026-04-15 - run a static web server in your current directory

`npx http-server`

### [json-server](https://github.com/typicode/json-server) ⭐ 75,693 | 🐛 720 | 🌐 JavaScript | 📅 2026-03-23 - run a mock REST API server with JSON-based response configuration
...
### [pa11y](https://github.com/pa11y/pa11y) ⭐ 4,493 | 🐛 42 | 🌐 JavaScript | 📅 2026-08-28 - check websites for accessibility issues
...
### [npm-check](https://github.com/dylang/npm-check) ⭐ 6,642 | 🐛 232 | 🌐 JavaScript | 📅 2026-08-29 - interactively update npm dependencies
...
### [snyk](https://github.com/snyk/snyk) ⭐ 5,652 | 🐛 135 | 🌐 TypeScript | 📅 2026-08-31 - scan for vulnerabilities in your project and its dependencies and even fix them (requires account with service)
...
### [figlet-cli](https://github.com/patorjk/figlet-cli) ⭐ 133 | 🐛 2 | 🌐 JavaScript | 📅 2026-01-21 - the classic multi-line ascii text generator, with font support
