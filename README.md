...
### [goops](https://github.com/captainsafia/goops) ⭐ 422 | 🐛 2 | 🌐 JavaScript | 📅 2022-08-01 - add gitignore rules heuristically based on files in your current directory

`npx goops`

### [http-server](https://github.com/indexzero/http-server) ⭐ 14,235 | 🐛 108 | 🌐 JavaScript | 📅 2026-04-15 - run a static web server in your current directory

`npx http-server`

### [json-server](https://github.com/typicode/json-server) ⭐ 75,709 | 🐛 721 | 🌐 JavaScript | 📅 2026-03-23 - run a mock REST API server with JSON-based response configuration
...
### [pa11y](https://github.com/pa11y/pa11y) ⭐ 4,528 | 🐛 44 | 🌐 JavaScript | 📅 2026-09-07 - check websites for accessibility issues

`npx pa11y http://example.com`

### [shx](https://github.com/shelljs/shx) ⭐ 1,871 | 🐛 22 | 🌐 JavaScript | 📅 2026-06-08 - portable shell commands like ls, cp, rm
...
### [npm-check](https://github.com/dylang/npm-check) ⭐ 6,641 | 🐛 232 | 🌐 JavaScript | 📅 2026-09-12 - interactively update npm dependencies
...
### [snyk](https://github.com/snyk/snyk) ⭐ 5,662 | 🐛 135 | 🌐 TypeScript | 📅 2026-09-15 - scan for vulnerabilities in your project and its dependencies and even fix them (requires account with service)
...
### [figlet-cli](https://github.com/patorjk/figlet-cli) ⭐ 134 | 🐛 2 | 🌐 JavaScript | 📅 2026-01-21 - the classic multi-line ascii text generator, with font support
